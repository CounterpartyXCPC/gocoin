...
func write_html_head(w http.ResponseWriter, r *http.Request) {
	...
	s = strings.Replace(s, "/*_CHAIN_IN_SYNC_*/", fmt.Sprint("var chain_in_sync = ", common.GetBool(&common.BchBlockChainSynchronized)), 1)
	...
	s = strings.Replace(s, "{VERSION}", gocoincash.Version, 1)
	if common.Testnet {
